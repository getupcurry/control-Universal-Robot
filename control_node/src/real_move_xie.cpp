...
int main(int argc, char **argv)
{
    ...
    joint_group_positions_camera[5] = 1.130;
    ...
    target_pose.position.y = 0.112239;
    target_pose.position.z = 0.337424;
...
*/
    ...
    target_pose1.position.x -= 0.015859;
...
//移动到爪夹
    ...
    joint_group_positions[5] = -0.628;  // radians
...
//p2
    ...
    target_pose4.orientation.x = 0.620431;
    target_pose4.orientation.y = 0.784092;
    target_pose4.orientation.z = 0.00994781;
    target_pose4.orientation.w = -0.0121478;

    target_pose4.position.x = -0.815982;
    target_pose4.position.y = 0.195657;
    target_pose4.position.z = 0.25182;

    arm.setPoseTarget(target_pose4);
    arm.move();

    geometry_msgs::Pose target_pose_p2_1 = arm.getCurrentPose().pose;
    target_pose_p2_1.position.x -= 0.02;
...
//螺栓枪开启
    ...
    //target_pose_p2_2.position.y += 0.040;
...
//p3
    ...
    target_pose5.orientation.x = 0.620431;
    target_pose5.orientation.y = 0.784092;
    target_pose5.orientation.z = 0.00994781;
    target_pose5.orientation.w = -0.0121478;

    target_pose5.position.x = -0.808975;
    target_pose5.position.y = 0.166191;
    target_pose5.position.z = 0.135872;

    arm.setPoseTarget(target_pose5);
    arm.move();

    geometry_msgs::Pose target_pose_p3_1 = arm.getCurrentPose().pose;
    target_pose_p3_1.position.x -= 0.02;
...
//螺栓枪开启
    ...
    //target_pose_p3_2.position.y += 0.040;
...
//p4
    ...
    target_pose6.orientation.x = 0.620431;
    target_pose6.orientation.y = 0.784092;
    target_pose6.orientation.z = 0.00994781;
    target_pose6.orientation.w = -0.0121478;

    target_pose6.position.x = -0.782809;
    target_pose6.position.y = 0.0543327;
    target_pose6.position.z = 0.103869;

    arm.setPoseTarget(target_pose6);
    arm.move();

    geometry_msgs::Pose target_pose_p4_1 = arm.getCurrentPose().pose;
    target_pose_p4_1.position.x -= 0.02;
...
//螺栓枪开启
    ...
    //target_pose_p4_2.position.y += 0.040;
...
//p5
    ...
    target_pose7.orientation.x = 0.620431;
    target_pose7.orientation.y = 0.784092;
    target_pose7.orientation.z = 0.00994781;
    target_pose7.orientation.w = -0.0121478;

    target_pose7.position.x = -0.762247;
    target_pose7.position.y = -0.030986;
    target_pose7.position.z = 0.18811;

    arm.setPoseTarget(target_pose7);
    arm.move();

    geometry_msgs::Pose target_pose_p5_1 = arm.getCurrentPose().pose;
    target_pose_p5_1.position.x -= 0.02;
...
//螺栓枪开启
    ...
    target_pose_p5_2.position.y += 0.040;
...
//p6
    ...
    target_pose8.orientation.x = 0.620431;
    target_pose8.orientation.y = 0.784092;
    target_pose8.orientation.z = 0.00994781;
    target_pose8.orientation.w = -0.0121478;

    target_pose8.position.x = -0.769022;
    target_pose8.position.y = -0.00113007;
    target_pose8.position.z = 0.305017;

    arm.setPoseTarget(target_pose8);
    arm.move();

    geometry_msgs::Pose target_pose_p6_1 = arm.getCurrentPose().pose;
    target_pose_p6_1.position.x -= 0.02;
...
//螺栓枪开启
    ...
    target_pose_p6_2.position.y += 0.040;
